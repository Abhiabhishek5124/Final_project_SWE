...
export default function App() {
  ...
  return (
    <div className="relative h-screen w-full flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600 overflow-hidden">
      {/* Background Cover */}
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full h-full px-4 md:px-0">
        ...
        >
          ...
          <SignedOut>
            <SignInButton>
              <button className="rounded-lg border border-white px-8 py-3 font-semibold text-black transition-all hover:bg-red-500 hover:text-white">
                Sign In
              </button>
            </SignInButton>
          </SignedOut>
          ...
          <SignedIn>
            <button 
              ...
              className="mt-4 rounded-lg border border-white px-8 py-3 font-semibold text-black transition-all hover:bg-green-500 hover:text-white"
            >
              Let's Get Started!
            </button>
          </SignedIn>
